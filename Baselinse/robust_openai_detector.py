...
for model_name in ["GPT4", "Gemini", "Claude"]:
    for attack_type in ["insert", "delete", "replace", "dipper"]:
        ...
        with open(f"/data/zhuxiaowei/project/AIDetection/DNA-DetectLLM/scores/text_attack/{model_name}_{attack_type}_openai_detector_machine_test.json", 'w') as fout:
