...
def experiment(args):
    ...
    all_length = []
    max_length = 1024
    with open(f"/data/zhuxiaowei/project/AIDetection/Related_dataset/DetectRL/DetectRL_multillm_machine_test.json", 'r+',
    ...
    with open(f'/data/zhuxiaowei/project/AIDetection/DNA-DetectLLM/scores/DetectRL_multillm_lastde_machine_test.json',
              'w') as out1:
